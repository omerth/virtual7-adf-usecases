package com.virtual7.bcCachingService.model.views.common;

import org.eclipse.persistence.sdo.SDODataObject;

public class DepartmentServiceVOSDOImpl extends SDODataObject implements DepartmentServiceVOSDO {

   public static final int START_PROPERTY_INDEX = 0;

   public static final int END_PROPERTY_INDEX = START_PROPERTY_INDEX + 3;

   public DepartmentServiceVOSDOImpl() {}
